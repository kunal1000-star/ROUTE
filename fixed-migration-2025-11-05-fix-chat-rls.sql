...
-- Note: ai_memory and ai_embeddings tables do not exist, so grants are removed
GRANT USAGE ON SCHEMA public TO authenticated;
GRANT ALL ON chat_conversations TO authenticated;
GRANT ALL ON chat_messages TO authenticated;
-- Removed grants for non-existent tables: ai_memory, ai_embeddings
...
BEGIN
    ...
    RAISE NOTICE 'Fixed: Removed non-existent table references (ai_memory, ai_embeddings)';
END $$;
